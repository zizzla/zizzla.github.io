---
layout: post
title: "Sandbatterier för ångleverans och balansering av elsystemet"
subtitle: "Hur högtemperaturlager kan kombinera ångleverans, Power-to-Heat och flexibilitet på mFRR."
excerpt: "Hur högtemperaturlager kan kombinera ångleverans, Power-to-Heat och flexibilitet på mFRR."
date: 2026-08-11
permalink: /blogg/sandbatterier-angleverans-balansering/
published: true
image: /assets/img/blog/sandbatterier/sandbatteri-hero.png
categories: flexibilitet
author:
...
<figure class="not-prose my-10 md:-mx-8 lg:-mx-16">
  <img src="{{ '/assets/img/blog/sandbatterier/drift-utan-mfrr.png' | relative_url }}" alt="Diagram över sandbatteriets drift utan mFRR med ångbehov, laddning, levererad ånga och elpris under en vecka." class="h-auto w-full rounded-xl border border-gray-200 bg-white" loading="lazy" width="1536" height="1024">
</figure>
...
<figure class="not-prose my-10 md:-mx-8 lg:-mx-16">
  <img src="{{ '/assets/img/blog/sandbatterier/drift-med-mfrr.png' | relative_url }}" alt="Diagram över sandbatteriets drift med mFRR där laddningen anpassas samtidigt som ångleveransen upprätthålls." class="h-auto w-full rounded-xl border border-gray-200 bg-white" loading="lazy" width="1536" height="1024">
</figure>
...
<figure class="not-prose my-10 md:-mx-8 lg:-mx-16">
  <img src="{{ '/assets/img/blog/sandbatterier/principdiagram-mfrr.png' | relative_url }}" alt="Principdiagram med planerad laddning, mFRR upp och ned, sandlagrets energinivå och stabil ångleverans." class="h-auto w-full rounded-xl border border-gray-200 bg-white" loading="lazy" width="1536" height="1024">
</figure>
